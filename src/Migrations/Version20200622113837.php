 ...
 */
final class Version20200622113837 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE params (id INT AUTO_INCREMENT NOT NULL, type_param INT NOT NULL, value VARCHAR(255) NOT NULL, color VARCHAR(8) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
